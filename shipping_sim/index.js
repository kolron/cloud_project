...
const generator = require("./qrGenerator");
 ...
 function SimShipment(products){
    ...
    const result = generator.generate(package);
    console.log(package)
...
setInterval(SimShipment,5000,products)


//   var result = generateItems(products).items
//   var gen_price = genereatePrice(result)
//   var price = gen_price.price
//   var status = gen_price.tax_status
//   console.log(result)
//   console.log("Price = " + price + " Status = "+ status)
